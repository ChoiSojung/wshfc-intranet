                    ...
                    <div className="max-w-md w-1/3">
                        <form className="px-4">
                            <div class="relative flex w-full flex-wrap items-stretch">
                                <input type="text" placeholder="What are you looking for?" className="bg-red-350 placeholder-gray-200 text-gray-200 relative rounded-lg border-2 focus:border-orange p-1 rounded-lg shadow-inner w-full"/>
