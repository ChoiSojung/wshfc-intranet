                    ...
                    <div className="max-w-md w-1/3">
                        <form className="px-4 hidden md:block">
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <input type="text" placeholder="What are you looking for?" className="bg-red-350 md:placeholder-blue-350 placeholder-blue-350 text-blue-350 relative rounded-lg border-2 focus:border-grey-200 p-1 rounded-lg shadow-inner w-full"/>
                                <span className="z-10 h-full leading-snug font-normal absolute text-center text-blue-350 absolute bg-transparent rounded text-base items-center justify-center w-8 right-0 pr-3 py-3">
                                    <svg className="text-blue-350 h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 56.966 56.966" xmlSpace="preserve" width="512px" height="512px"><path
