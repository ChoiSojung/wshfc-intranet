        ...
        <div>
            ...
            <div className="bg-gray-300 flex flex-col items-center mb-4 min-h-screen">
                ...
                <div className="flex flex-col items-center w-full bg-red-350 shadow-xl">
                    <div className="max-w-6xl m-4">
                        <div className="flex flex-col justify-center items-center"> 
                            <Link href="/about">
                                <a>
                                    <h1 className="font-serif hover:text-gray-300 hover:border-gray-300 py-2 text-3xl text-gray-100 border-b border-gray-100">
                                        About Us
                                    </h1>
                                </a>
                            </Link>
                ...
                <MainWrapper>
                    ...
                    <div className="px-6">
                            ...
                            <div className="mt-2 md:w-1/2">
                                <a href="#commission">
                                    <div className="h-full flex flex-col items-center md:mx-2 bg-red-350 rounded-lg p-2 hover:bg-yellow-600">
                                        <p className="text-md font-bold text-gray-100 text-center">The Commission</p>
                                    </div>
                                </a>
                            </div>
                            <div className="mt-2 md:w-1/2">
                                <a href="#organization">
                                    <div className="h-full flex flex-col items-center md:mx-2 bg-red-350 rounded-lg p-2 hover:bg-yellow-600">
                                        <p className="text-md font-bold text-gray-100 text-center">Organization</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-450 mt-16 p-2 border-2 border-gray-400">
                            <h2 className="text-2xl text-blue-350 text-center" id="commission">The Commission</h2>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:-mx-2 mb-2">
                            <div className="mt-4 md:w-1/2">
                                <div className="bg-gray-100 h-full p-8 border-b-4 border-red-350 rounded-lg flex flex-col items-center md:mx-2 md:p-3 md:p-8">
                                    <div className="font-serif font-bold text-gray-700 text-xl text-yellow-600 text-center">History</div>
                            ...
                            <div className="mt-4 md:w-1/2">
                                <div className="bg-gray-100 h-full p-8 border-b-4 border-red-350 rounded-lg flex flex-col items-center md:mx-2 md:p-3 md:p-8">
                                    <div className="font-serif font-bold text-yellow-600 text-xl text-center">Info Library</div>
                                    <div className="mt-4 text-gray-700 text-md text-center">
                                        <ul className="list-decimal list-inside">
                        ...
                        <div className="bg-gray-450 mt-16 p-2 border-2 border-gray-400">
                            <h2 className="text-2xl text-blue-350 text-center" id="organization">Organization</h2>
                        </div>
                        
                        <div className="flex flex-col md:flex-row md:-mx-2 mb-2">
                            <div className="mt-4 md:w-1/2">
                                <div className="bg-gray-100 h-full p-8 border-b-4 border-red-350 rounded-lg flex flex-col items-center md:mx-2 md:p-3 md:p-8">
                                    <div className="font-serif font-bold text-yellow-600 text-xl text-center">Internal</div>
                                    <div className="mt-4 text-gray-700 text-md text-center">
                                        <ul className="list-decimal list-inside">
                            ...
                            <div className="mt-4 md:w-1/2">
                                <div className="bg-gray-100 h-full p-8 border-b-4 border-red-350 rounded-lg flex flex-col items-center md:mx-2 md:p-3 md:p-8">
                                    <div className="font-serif font-bold text-yellow-600 text-xl text-center">Commissioner/Board Meetings</div>
                                    <div className="mt-4 text-gray-700 text-md text-center">
                                        <ul className="list-decimal list-inside">
