    ...
    return (
        ...
        <div>
            ...
            <div className="bg-blue-350 flex flex-col items-center mb-4">
                ...
                <div className="flex flex-col items-center w-full bg-red-350">
                                ...
                                <div className="px-6">
                                    ...
                                    <div className="mt-4 flex flex-col md:flex-row md:-mx-2">
                                        <div className="mt-2 md:w-1/2">
                                            <a href="#commission">
                                                <div className="h-full flex flex-col items-center md:mx-2 bg-red-350 rounded-lg p-2 hover:bg-yellow-400">
                                                    <p className="text-md font-bold text-gray-100 text-center">Commission</p>
                                                </div>
                                            </a>
                                        </div>
                                        <div className="mt-2 md:w-1/2">
                                    ...
                                    <div className="bg-gray-450 mt-16 p-2 border-2 border-gray-400">
                                        <h2 className="text-2xl text-blue-350 font-bold text-center" id="commission">Commission</h2>
                                    </div>
                                    ...
                                    <div className="bg-gray-450 mt-16 p-2 border-2 border-gray-400">
                                        <h2 className="text-2xl text-blue-350 font-bold text-center" id="organization">Organization</h2>
                                    </div>
